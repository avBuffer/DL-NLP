...
if __name__ == '__main__':
    ...
    for epoch in range(max_iter):
        for idx, (input_ids, segment_ids, masked_tokens, masked_pos, isNext) in enumerate(loader):
            ...
            if epoch % save_interval == 0:
                model_file = os.path.join(ckpt_path, "bert_{}-{}.th".format(epoch, loss.item()))
    ...
    print('text=', [idx2word[w] for w in input_ids if idx2word[w] != '[PAD]'])
