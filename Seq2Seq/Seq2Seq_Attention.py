...
if __name__ == '__main__':
    ...
    spacy_de = spacy.load('multi30k/train.de')
    spacy_en = spacy.load('multi30k/train.en')
    #spacy_de = 'Cho et al., Lernen von Phrasendarstellungen unter Verwendung von RNN Encoder-Decoder für statistische maschinelle Übersetzung'
    #spacy_en = 'Cho et al., Learning Phrase Representations using RNN Encoder-Decoder for Statistical Machine Translation'
    ...
    for epoch in range(max_iter):
        ...
        if epoch % save_interval == 0:
            model_file = os.path.join(ckpt_path, "seq2seq_attention_{}-{}.th".format(epoch, valid_loss))
            print('epoch=', epoch, 'valid_loss=', valid_loss, 'model_file=', model_file)
