...
if __name__ == '__main__':
    ...
    parser = OptionParser()
    parser.add_option('-i', '--input', dest='input_file', default='data/corpus.zhwiki.txt', help='traditional file')
    parser.add_option('-o', '--output', dest='output_file', default='data/corpus.zhwiki.simplified.txt', help='simplified file')
