...
if __name__ == '__main__':
    ...
    parser = OptionParser()
    parser.add_option('-i', '--input', dest='infile', default='data/zhwiki-latest-pages-articles.xml.bz2', help='input: Wiki corpus')
    parser.add_option('-o', '--output', dest='outfile', default='data/corpus.zhwiki.txt', help='output: Wiki corpus')
