...
if __name__ == '__main__':
    ...
    parser = OptionParser()
    parser.add_option('-i', '--input', dest='infile', default='data/corpus.zhwiki.simplified.txt', help='input file to be preprocessed')
    parser.add_option('-o', '--output', dest='outfile', default='data/corpus.zhwiki.simplified.done.txt', help='output file removed english and blank')
