...
if __name__ == '__main__':
    ...
    parser = OptionParser()
    parser.add_option('-i', '--input', dest='infile', default='data/corpus.zhwiki.segwithb.txt', help='zhwiki corpus')
    parser.add_option('-m', '--outmodel', dest='wv_model', default='model/zhwiki.word2vec.model', help='word2vec model')
    parser.add_option('-v', '--outvec', dest='wv_vectors', default='model/zhwiki.word2vec.vectors', help='word2vec vectors')
    parser.add_option('-s', type='int', dest='size', default=300, help='word vector size')
